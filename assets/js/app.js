...
!function (t, e) {
  ...
  function Ci(e, i, n) {
    var r = {};
    if ($(i) && (i = i.options), i.extends && (e = Ci(e, i.extends, n)), i.mixins) for (var t = 0, o = i.mixins.length; t < o; t++) {
      e = Ci(e, i.mixins[t], n);
    }
  ...
  function Oi(t, e) {
    ...
    if (void 0 === u && (u = 0), Wt(t)) {
      ...
      for (var i = se.resolve(), n = function n(e) {
        i = i.then(function () {
          return new se(function (i) {
            var n = c[e],
                ...
                a = function a() {
              var t,
                  e = (t = tt((Date.now() - s) / h), .5 * (1 - Math.cos(Math.PI * t)));
  ...
  qi.util = Object.freeze({
    ...
    t && t.forEach(function (t) {
      if (u(t, "handler")) on(i, t);else for (var e in t) {
        on(i, t[e], e);
      }
    });
    ...
    methods: {
      ...
      _toggleElement: function _toggleElement(t, e, i) {
        ...
        var r,
            ...
            p,
            g,
            m = ($(i) ? i : !1 !== i && this.hasAnimation ? this.hasTransition ? (c = (u = this).isToggled, l = u.duration, d = u.initProps, f = u.hideProps, p = u.transition, g = u._toggle, function (t, e) {
  ...
  var ir = {
    ...
    computed: {
      matchMedia: function matchMedia() {
        var t = function (t) {
          if (D(t)) {
            if ("@" === t[0]) t = j(Ue("breakpoint-" + t.substr(1)));else if (isNaN(t)) return t;
          }
    ...
    mixins: [{
      ...
      methods: {
        ...
        move: function move(t) {
          ...
          if (Xt(window, "scroll", this.unbindMove), this.unbindMove && this.unbindMove(), Xt(document, mt, this.end, !0), this.dragging) if (this.dragging = null, this.index === this.prevIndex) this.percent = 1 - this.percent, this.dir *= -1, this._show(!1, this.index, !0), this._transitioner = null;else {
...
module.exports = __webpack_require__(/*! /Users/daaef/Projects/JTG/src/assets/js/app.js */"./src/assets/js/app.js");
